...
| §19 Roadmap, item 26 (tutorial guiado por página)                                                                                                                                 | [`roadmap-26-tutoriales.md`](./roadmap-26-tutoriales.md) — mayormente cerrado, recortado a índice (ver `docs/sistema/tutoriales-atajos.md`); conserva sólo los sub-ítems todavía abiertos. |
