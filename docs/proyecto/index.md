...
| §10 Búsqueda y navegación, §11 Editor de escritura, §12 Versionado (spec), §13 Objetivos, §14 Recordatorios, §15 Calendario, §16 Música, §17 Temas | [`features.md`](./features.md)                                                                                                                                                               |
...
| §19 Roadmap, items 22-25+ (dashboard, navegación por carpetas, testing, dormancia de metas, y lo que se agregue después)                           | [`roadmap-22-25.md`](./roadmap-22-25.md) — **bucket abierto**: los próximos ítems del roadmap se agregan acá hasta que vuelva a pesar demasiado, y ahí se corta un `roadmap-26-NN.md` nuevo. |
