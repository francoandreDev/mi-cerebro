...
| §19 Roadmap, item 26 (tutorial guiado por página)                                                                                                                                 | [`roadmap-26-tutoriales.md`](./roadmap-26-tutoriales.md) — cerrado como bucket: pesaba demasiado (1350+ líneas), se cortó `roadmap-27-NN.md` para el siguiente ítem. |
