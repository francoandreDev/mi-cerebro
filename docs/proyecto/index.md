...
| §19 Roadmap, item 26+ (tutorial guiado por página, y lo que se agregue después)                                                                    | [`roadmap-26-tutoriales.md`](./roadmap-26-tutoriales.md) — **bucket abierto**: los próximos ítems del roadmap se agregan acá hasta que vuelva a pesar demasiado, y ahí se corta un `roadmap-27-NN.md` nuevo. |
