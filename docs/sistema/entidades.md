...
**Modelo:** `FileCollection` con `title`, `tags`, `order: string[]`, `items: FileItem[]` (cada uno con `id`, `originalName`, `mime`, `ext`, `bytes`, `addedAt`).
