...
- 2026-07-04 (sesión 2): se cerraron 3 ítems más — "Snippet centrado en la coincidencia" (Tier 2 #5, ahora §19.16d), "UI dedicada de gestión de tags" (Tier 2 #10, ahora §19.16c) y "Color picker custom para tag" (Tier 1 #2, resultó ser una entrada obsoleta — ya estaba resuelta desde §19.15 y nadie había actualizado `deferred.md`). Este ranking no se renumeró a mano (ver nota de arriba); tratar los números de ítem como referencias históricas y confirmar contra `deferred.md` antes de tomar el próximo.
