...
12. **Menú ⋯ con duplicar / exportar a Markdown (books)** (esfuerzo: medio, Tier 3 — `BooksService` + converter ProseMirror→MD) — exportar a MD es portabilidad real de contenido propio, no sólo cosmético.
