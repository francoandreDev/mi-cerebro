...
12. **Reminders.**
13. **Music player.**
14. **Versionado** (isomorphic-git).
15. **Export ZIP.**
16. **Temas custom + validación WCAG.** Incluye color picker custom para tags (hoy el color sale determinístico de un hash).
17. **Pulido** — partido en sub-fases temáticas para mantener scope acotado:
