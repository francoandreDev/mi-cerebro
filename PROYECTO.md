...
16. **Pulido** — partido en sub-fases temáticas para mantener scope acotado:
    ...
    - **16d.** Pulido de búsqueda: ~~botón "reindexar" manual~~ (resuelto 2026-07-04, adelantado fuera de orden — botón en `/settings` → General, llama `WorkspaceRefreshService.refreshAll()`), snippet centrado en la coincidencia con highlight (en lugar de los primeros 160 chars del body).
