...
export const es = {
  ...
  'variants.graph.overview.aria': 'Topología de variantes ({n})',
  'variants.graph.overview.title': 'Topología',
  'variants.graph.overview.hint':
    'Hover para resaltar la tarjeta · click para acciones · click en HEAD o milestone para abrir /history.',
  'variants.graph.lane.aria': 'Variante {name}: enter abre el menú de acciones',
  'variants.graph.head.aria': 'Abrir historial en el último commit de {name}',
  'variants.graph.milestone.aria': 'Abrir historial en el milestone {name}',
  'variants.filters.search': 'Buscar',
  'variants.filters.search.placeholder': 'nombre, sha, subject, milestone…',
  'variants.filters.state': 'Estado',
  'variants.filters.state.all': 'Todos',
  'variants.filters.state.active': 'Activas',
  'variants.filters.state.principal': 'Principal',
  'variants.filters.state.dormant': 'En reposo',
  'variants.filters.parent': 'Forkeado desde',
  'variants.filters.parent.all': 'Cualquier origen',
  'variants.filters.clear': 'Limpiar filtros',
  'variants.filters.summary': '{n} de {total} variantes coinciden',
  'variants.filters.empty': 'Ninguna variante coincide con los filtros actuales.',
