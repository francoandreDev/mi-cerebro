...
export const es = {
  ...
  'goals.editor.starOpenHint': 'Click: marcar · Shift+click: menú',
  ...
  'goals.editor.firstStarHint':
    'Tocá una estrella para marcarla · arrastrala para moverla · clic derecho o shift+clic para más opciones',
