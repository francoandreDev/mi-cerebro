...
export const es = {
  ...
  'lists.shelf.searchPlaceholder': 'Buscar listas...',
  'lists.shelf.searchAria': 'Buscar listas',
  'lists.shelf.searchClear': 'Limpiar búsqueda',
  'lists.shelf.filtersClear': 'Quitar filtros',
  'lists.shelf.tagsLabel': 'Filtrar por etiquetas',
  'lists.shelf.noMatch': 'Ninguna lista coincide con el filtro.',
  'lists.shelf.newPlaceholder': 'Nueva lista. Escribí el título y enter',
  'lists.shelf.newAria': 'Crear nueva lista',
  'lists.shelf.newSubmit': 'Crear lista',
  'lists.shelf.emptyHeadline': 'Tus listas vivirán acá',
  'lists.shelf.emptyHint': 'Escribí el título de tu primera lista y enter.',
  'lists.shelf.openAria': 'Abrir lista {title}',
  'lists.shelf.deleteAria': 'Eliminar lista {title}',
  'lists.shelf.moreItems': '+{count} más',
  'lists.shelf.cardEmpty': 'Lista vacía. Abrila para agregar ítems.',
