...
export const es = {
  ...
  'images.images.density.label': 'Tamaño de las imágenes',
  'images.images.density.compact': 'Compacto',
  'images.images.density.cozy': 'Mediano',
  'images.images.density.large': 'Grande',
  ...
  'files.shelf.itemOne': 'archivo',
  'files.shelf.itemMany': 'archivos',
  'files.shelf.openAria': 'Abrir colección {title}',
  'files.shelf.empty': 'Aún no hay colecciones. Empezá con "Nueva colección".',
  'files.shelf.newCollection': 'Nueva colección',
