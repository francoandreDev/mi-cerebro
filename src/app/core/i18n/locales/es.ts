...
export const es = {
  ...
  'music.placeholder.resonantSurface': 'Superficie resonante — próximamente (Fase 8)',
  ...
  'music.placeholder.waveform': 'Waveform y metadata real — próximamente (Fase 9)',
  'music.placeholder.playlistsModal': 'Playlists (provisional — modal en Fase 11)',
