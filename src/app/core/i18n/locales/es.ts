...
export const es = {
  ...
  'versioning.history.rangeCompaction.toggle': 'Compactar un rango…',
  'versioning.history.rangeCompaction.from': 'Desde',
  'versioning.history.rangeCompaction.to': 'Hasta',
  'versioning.history.rangeCompaction.cta': 'Compactar rango',
  'versioning.history.rangeCompaction.compacting': 'Compactando…',
  'versioning.history.rangeCompaction.confirm.title': 'Compactar rango de historial',
  'versioning.history.rangeCompaction.confirm.body':
    'Se van a fusionar en un solo commit por rama todos los commits entre {from} y {to} (los hitos y puntos de restauración nunca se tocan). Reescribe el historial de git y no se puede deshacer manualmente — queda un snapshot automático antes de aplicar.',
  'versioning.history.rangeCompaction.confirm.confirm': 'Compactar',
  'versioning.history.rangeCompaction.confirm.cancel': 'Cancelar',
  ...
  'versioning.history.zoom.legend.detail': 'polaroids por commit individual',
  ...
  'tasks.garden.legend.aria': 'Referencia de símbolos del jardín',
  ...
  'chalk.toggle': 'Modo tiza',
  'chalk.toggleAria': 'Activar o desactivar modo tiza',
  'chalk.on': 'Tiza on',
  'chalk.off': 'Tiza',
  'chalk.toolAria': 'Herramienta',
  'chalk.tool.chalk': 'Tiza',
  'chalk.tool.eraser': 'Goma',
  'chalk.colorAria': 'Color de tiza',
  'chalk.color.white': 'Blanca',
  'chalk.color.yellow': 'Amarilla',
  'chalk.color.pink': 'Rosa',
  'chalk.color.blue': 'Celeste',
  'chalk.color.green': 'Verde',
  'chalk.sizeAria': 'Grosor',
  'chalk.size.s': 'Fino',
  'chalk.size.m': 'Medio',
  'chalk.size.l': 'Grueso',
  'chalk.undo': 'Deshacer trazo',
  'chalk.undoAria': 'Deshacer el último trazo o acción de capa',
  'chalk.redo': 'Rehacer trazo',
  'chalk.redoAria': 'Rehacer el último trazo o acción de capa deshecha',
  'chalk.shortcuts.toggle': 'Tiza · Alternar modo tiza',
  'chalk.shortcuts.chalk': 'Tiza · Elegir tiza',
  'chalk.shortcuts.eraser': 'Tiza · Elegir goma',
  'chalk.shortcuts.undo': 'Tiza · Deshacer trazo',
  'chalk.shortcuts.redo': 'Tiza · Rehacer trazo',
  'chalk.shortcuts.color.white': 'Tiza · Color blanco',
  'chalk.shortcuts.color.yellow': 'Tiza · Color amarillo',
  'chalk.shortcuts.color.pink': 'Tiza · Color rosa',
  'chalk.shortcuts.color.blue': 'Tiza · Color celeste',
  'chalk.shortcuts.color.green': 'Tiza · Color verde',
  'chalk.clear': 'Borrar capa',
  'chalk.clearConfirm': '¿Borrar todos los trazos de la capa activa?',
  'chalk.confirm.clear.title': 'Vaciar capa',
  'chalk.confirm.clear.confirm': 'Sí, vaciar',
  'chalk.confirm.cancel': 'Cancelar',
  'chalk.layers': 'Capas',
  'chalk.layersHint':
    'Cada capa junta sus propios trazos — mostralos, ocultalos o bloquealos por separado sin tocar el resto.',
  'chalk.export': 'Exportar',
  'chalk.layersEmpty': 'Sin capas todavía. El primer trazo crea una.',
  'chalk.layerEmpty': 'Vacía',
  'chalk.strokeCount': '{n} trazos',
  'chalk.addLayer': 'Nueva capa',
  'chalk.layerDefault': 'Capa {n}',
  'chalk.layerName': 'Nombre de la capa',
  'chalk.selectLayer': 'Activar esta capa',
  'chalk.show': 'Mostrar capa',
  'chalk.hide': 'Ocultar capa',
  'chalk.lock': 'Bloquear capa',
  'chalk.unlock': 'Desbloquear capa',
  'chalk.moveUp': 'Mover capa arriba',
  'chalk.moveDown': 'Mover capa abajo',
  'chalk.removeLayer': 'Eliminar capa',
  'chalk.removeConfirm': '¿Eliminar la capa "{name}" y sus trazos?',
  'chalk.confirm.remove.title': 'Eliminar capa',
  'chalk.confirm.remove.confirm': 'Sí, eliminar',
  ...
  'books.tutorial.readerDraw.title': 'Modo dibujo',
  'books.tutorial.readerDraw.body':
    'Dibujá a mano alzada sobre la página, con grosor y color propios — convive con el texto, no lo reemplaza.',
  ...
  'books.editor.draw.toggle': 'Modo dibujo',
  'books.editor.draw.toggleAria': 'Activar o desactivar dibujo a mano alzada en la página',
  'books.editor.comment': 'Comentar',
  'books.editor.propose': 'Proponer cambio',
  'books.editor.selectTextHint': 'Seleccioná texto para comentar o proponer un cambio',
  ...
  'images.images.dropHint': 'Arrastrá imágenes acá, pegá con Ctrl+V o usá "Agregar imágenes".',
  ...
  'editor.bubble.link': 'Vincular a…',
  'editor.linkPicker.placeholder': 'Buscar una entidad para vincular...',
  'editor.linkPicker.empty': 'No se encontró nada.',
  ...
  'reminders.noteLabel': 'Nota',
  'reminders.notePlaceholder': 'Agregá una nota (opcional)…',
  'reminders.ronroneoHint': 'Mantené el cursor sobre la paloma para ver la nota',
  ...
  'comments.empty.hint':
    'Seleccioná texto en el editor y comentá desde el menú que aparece, o con Alt+C.',
  ...
  'connections.unlink': 'Desvincular',
  'connections.untitled': 'Sin título',
  'connections.viewOnMap': 'Ver en el mapa',
  'connections.graph.title': 'Mapa de conexiones',
  'connections.graph.back': 'Volver',
  'connections.graph.open': 'Abrir',
  'connections.graph.empty': 'Esta entidad no tiene conexiones.',
  ...
  'drafts.session.branchBadge': 'Editando en la rama Borrador de «{name}»',
  ...
  'sync.panel.dispatchCount': '{count} envíos hoy',
  'sync.mute.mute': 'Silenciar silbido de despacho',
  'sync.mute.unmute': 'Activar silbido de despacho',
