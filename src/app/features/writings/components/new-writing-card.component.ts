...
@Component({
  ...
  template: `
    ...
    >
      ...
      <label class="row">
        <mc-icon name="pen-nib" class="icon mc-anim-pulse" aria-hidden="true" />
        <input
          #input
          type="text"
          class="input"
          [attr.aria-label]="t('writings.shelf.newAria')"
          [placeholder]="t('writings.shelf.newPlaceholder')"
          [disabled]="busy()"
          autocomplete="off"
        />
        <button
          type="submit"
          class="submit"
          [attr.aria-label]="t('writings.shelf.newSubmit')"
          [disabled]="busy()"
        >
